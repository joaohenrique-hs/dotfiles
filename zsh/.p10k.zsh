# Generated by Powerlevel10k configuration wizard on 2020-02-26 at 13:04 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=057
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=129
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%044F'   # green foreground
      local   modified='%178F'  # yellow foreground
      local  untracked='%050F'   # blue foreground
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=23
  # Custom icon.
